                ...
                <table class="datatable-init nk-tb-list nk-tb-ulist col-md-12" data-auto-responsive="false">
                    <thead class="thead-dark">
                        <tr class="nk-tb-item nk-tb-head">
                            ...
                            <th class="nk-tb-col tb-col-md">Create Tracking</th>
                        ...
                        @foreach ($orders as $order)
                            @if ( $setting->order_status == 'all')
                                ...
                                <td class="nk-tb-col tb-col-md">
                                    ...
                                    <a href="{{ route('admin.createshipping',$order->id) }}"  class="btn btn-sm btn-dim btn-primary"><i class="icon ni ni-cart"></i></a>
                                </td>
                                {{-- <td class="nk-tb-col tb-col-lg">
                                    <div class="form-group">
                                        <div class="form-control-wrap">
