                            ...
                            <div class="card-inner card-inner-lg">
                                ...
                                <form method="POST" action="{{ route('password.update') }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="email" class="form-control form-control-lg @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus id="default-01" placeholder="Enter your email address">
                                     @error('email')
