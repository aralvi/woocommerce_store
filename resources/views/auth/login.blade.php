...
<head>
    ...
    <!-- Page Title  -->
    <title>Login | DashLite Admin </title>
    <!-- StyleSheets  -->
                            ...
                            <div class="card-inner card-inner-lg">
                                ...
                                <form method="POST" action="{{ route('login') }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="email" class="form-control form-control-lg @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus placeholder="Enter your email address or username">
                                        @error('email')
