                ...
                <div class="nk-sidebar-element nk-sidebar-head">
                    <div class="nk-sidebar-brand">
                        <a href="html/index.html" class="logo-link nk-sidebar-logo">
                            <img class="logo-light logo-img" src="{{ asset('assets/images/icons/logo.png') }}"
                                srcset="{{ asset('assets/images/icons/logo2x.png 2x') }}" alt="logo" />
                            <img class="logo-dark logo-img" src="{{ asset('assets/images/icons/logo-dark.png') }}"
                                srcset="{{ asset('assets/images/icons/logo-dark2x.png 2x') }}" alt="logo-dark" />
                            <img class="logo-small logo-img logo-img-small"
                                src="{{ asset('assets/images/icons/logo-small.png') }}"
                                srcset="{{ asset('assets/images/icons/logo-small2x.png 2x') }}" alt="logo-small" />
                        </a>
                    </div>
                            ...
                            <ul class="nk-menu">
                                ...
                                <li class="nk-menu-item has-sub {{ Request::is('orders*')?'active':'' }}">
                                    ...
                                    <ul class="nk-menu-sub">
                                        <li class="nk-menu-item {{ Request::is('orders*')?'active':'' }}">
                                            <a href="{{ route('orders.index') }}" class="nk-menu-link "><span
                                ...
                                <li class="nk-menu-item has-sub">
                                    ...
                                    <ul class="nk-menu-sub">
                                        <li class="nk-menu-item">
                                            <a href="html/user-list-default.html" class="nk-menu-link"><span
                                                    class="nk-menu-text">Curior Companies</span></a>
                                        </li>
                                    </ul>
                                    <!-- .nk-menu-sub -->
                                </li>
                            ...
                            <div class="nk-header-brand d-xl-none">
                                <a href="html/index.html" class="logo-link">
                                    ...
                                    <img class="logo-dark logo-img"
                                        src="{{ asset('assets/images/icons/logo-dark.png') }}"
                                        srcset="{{ asset('assets/images/icons/logo-dark2x.png 2x') }}"
                                        alt="logo-dark" />
                                </a>
                            </div>
                            <!-- .nk-header-brand -->
                                                ...
                                                <div class="dropdown-body">
                                                    <ul class="chat-list">
                                                        ...
                                                        <li class="chat-item">
                                                            <a class="chat-link" href="html/apps-chats.html">
                                                                <div class="chat-media user-avatar">
                                                                    <img src="{{ asset('assets/images/avatar/b-sm.jpg') }}"
                                    alt="" />
                            </div>
                            <div class="chat-info">
                                <div class="chat-from">
                            ...
                            <li class="chat-item">
                                <a class="chat-link" href="html/apps-chats.html">
                                    ...
                                    <div class="chat-info">
                                        ...
                                        <div class="chat-context">
                                            <div class="text">You: I just bought a new computer but i am having some
                                                problem</div>
