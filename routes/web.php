...
Route::group([ 'middleware' => ['auth']], function () {
    ...
    Route::get('add/tracking/info','Admin\OrderController@createTrackingInfo')->name('add.tracking.info');
    // Route::get('addconsignment/{id}','Admin\OrderController@addConsignment')->name('add.consignment');
    Route::get('addconsignment','Admin\OrderController@addConsignment')->name('add.consignment');
